...
public class Cifar10AudioClassifier implements TrainedModelLoader, AudioClassifier, AutoCloseable {
    ...
    public void load_model() throws IOException {
    	// cifar model is a trained model generated by Python library "Keras"
    	// it is using neural network to train the model
    	// dataset GTZAN details:
    	// The dataset consists of 1000 audio tracks each 30 seconds long. 
    	// It contains 10 genres, each represented by 100 tracks. The tracks are 
